function [wave_segs winstart_all] = parsechans(wave,breaths,srate,event_times,winsize,brth_num)
...
for i=1:length(event_times); %number of trials
    a = find((event_times(i)-seek_time) <= tdt_breaths & tdt_breaths <= (event_times(i)+seek_time));
